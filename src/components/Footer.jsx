            ...
            <div className='max-w-[90%] md:max-w-[1200px] mx-auto pt-16 md:pt-20 pb-10'>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-gray-700/60">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2.5 text-sm text-gray-400">
                            <li><button onClick={() => handlePolicyClick('About DigiTools')} className="hover:text-white transition-colors text-left">About Us</button></li>
                            <li><button onClick={() => handlePolicyClick('Careers')} className="hover:text-white transition-colors text-left">Careers</button></li>
                            <li><button onClick={() => handlePolicyClick('Press Kit')} className="hover:text-white transition-colors text-left">Press Kit</button></li>
                            <li><button onClick={() => handlePolicyClick('Contact Support')} className="hover:text-white transition-colors text-left">Contact</button></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex gap-3 mb-4">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="w-9 h-9 rounded-full bg-gray-800 hover:bg-red-600 flex items-center justify-center text-gray-300 hover:text-white transition-all"
                                aria-label="DigiTools on YouTube"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" className="fill-current">
