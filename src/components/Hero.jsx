...
const Hero = () => {
    return (
        <div className='max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center items-center py-[60px]'>
            <div className="text">
                ...
                <h1 className='text-[72px] font-extrabold'>Supercharge Your Digital Workflow</h1>
